@echo off
REM ================================================================
REM   Generate libsciter.a (MinGW i386 import library)
...
echo [STEP 1/3] Auto-generating sciter.def (embedded into this bat) ...
(
...
echo [STEP 2/3] Auto-generating libsciter.a via dlltool ...
if exist libsciter.a del /F /Q libsciter.a
%DLLTOOL% -d sciter.def -D sciter.dll -l libsciter.a -k -m i386 --as-flags=--32
if errorlevel 1 (
  echo [ERROR] dlltool failed!  Cannot build import library libsciter.a.
  del /F /Q sciter.def
  pause
  exit /b 1
)
...
ar t libsciter.a
echo.
echo [OK] libsciter.a generated successfully.
